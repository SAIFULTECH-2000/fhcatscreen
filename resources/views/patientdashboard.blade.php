...
@section('content')
 ...
 <div id="myHeader">
        ...
        <div class="txt-title"><p>Survey</p></div>
		<br><br>
    <div class="patient-survey">
        <div class="row">
        <div class="form-group">
            <img src="{{asset('img/user-picture.png')}}"></div>
        <div class="form-group">
...
<div class="row">
<div class="col-custom2 boxShadow-top">


    <div class="row but-survey-square justify-content-center align-content-center">
      <button onclick="location.href='{{URL::to('/dllc')}}/{{$patient->patientid}}'" id="dlcc_section" class="col-custom3 boxShadow-top2 mb-3">DLCC</button>
      <button onclick="location.href='{{URL::to('/sb')}}/{{$patient->patientid}}'" id="sb_section" class="col-custom3 boxShadow-top2 mb-3">SB</button> 
      <button onclick="location.href='{{URL::to('/jfhmc')}}/{{$patient->patientid}}'" id="jfhmc_section" class="col-custom3 boxShadow-top2 mb-3">JFHMC</button> 
      <button onclick="location.href='{{URL::to('/usmedped')}}/{{$patient->patientid}}'" id="usmedped_section" class="col-custom3 boxShadow-top2 mb-3">US MEDPED</button>       
    </div>
    ...
    <tbody>
        ...
        <th scope="row">1</th>
            <td>DLCC</td>
            <td class="score1">{{$score->total_dlcc;}}</td>
            <td class="category1">{{$score->result_dlcc}}</td>
        </tr>
        <tr>
        <th scope="row">2</th>
            <td>Simon Broom Diagnostic Criteria</td>
            <td class="score2">-</td>
            <td class="category2">{{$score->result_sb}}</td>
        </tr>
        <tr>
        <th scope="row">3</th>
            <td>Japanese Familial Hypercholesterolaemia Management Criteria</td>
            <td class="score3">-</td>
            <td class="category3">{{$score->result_jfhmc}}</td>
        </tr>
        <tr>
        <th scope="row">4</th>
            <td>US MEDPED Program Diagnostic Criteria for Familial Hypercholesterolaemia</td>
            <td class="score4">-</td>
            <td class="category4">{{$score->result_us}}</td>
        </tr>
		<tr>
        <th scope="row">5</th>
            <td>Cardiovascular Risk Category</td>
            <td class="score4">-</td>
            <td class="category4">{{$score->result_risk}}</td>
        </tr>
    </tbody>
    </table>
    ...
    <div class="row">
      <div class="col-md-4 mb-3">
        <button type="button" class="btn btn-secondary btn-block but-color-white" value="Print" onclick="PrintDiv();" >Print<i class="fa fa-print fa-lg" aria-hidden="true"></i></button>
      </div>
      <div class="col-md-4 mb-3">
        @php
            $urls= "editpatient/$patient->patientid";
        @endphp
        <button type="button" onclick="location.href='{{URL::to($urls)}}'" class="btn btn-secondary btn-block but-color-white">Edit Registration<i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></button>
      </div>
      <div class="col-md-4 mb-3">
        <button type="button" onclick="location.href='{{URL::to('/dashboard')}}'" class="btn btn-secondary btn-block but-color-purple">Finish<i class="fa fa-sign-out fa-lg" aria-hidden="true"></i></button>
      </div>
    </div>
